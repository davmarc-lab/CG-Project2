...
void Shader::clearShader() { glDeleteShader(this->id); }

void Shader::setBool(const string &name, bool value) { glUniform1i(glGetUniformLocation(this->getId(), name.c_str()), (int)value); }

void Shader::setInt(const string &name, bool value) { glUniform1i(glGetUniformLocation(this->getId(), name.c_str()), value); }

void Shader::setFloat(const string &name, bool value) { glUniform1f(glGetUniformLocation(this->getId(), name.c_str()), value); }
