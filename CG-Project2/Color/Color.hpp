...
class Color {
  ...
  public:
    ...
    Color(float red, float green, float blue) {
        this->color = vec4(red < 0 || red > 1 ? 1.0 : red, green < 0 || green > 1 ? 1.0 : green, blue < 0 || blue > 1 ? 1.0 : blue, 1.0);
    }

    // This constructor creates a color from rgba values.
    Color(float red, float green, float blue, float a) {
        this->color =
            vec4(red < 0 || red > 1 ? 1.0 : red, green < 0 || green > 1 ? 1.0 : green, blue < 0 || blue > 1 ? 1.0 : blue, a < 0 || a > 1 ? 1.0 : a);
    }
...
namespace color {
    ...
    const vec4 GRAY = vec4(0.3, 0.3, 0.3, 0.8);
} // namespace color
