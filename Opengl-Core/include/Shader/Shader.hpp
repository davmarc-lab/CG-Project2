...
namespace ogl {
	...
	public:
		...
		Shader(const std::string& location, const std::string& file, const shader::ShaderType& type) : m_location(std::move(location)), m_file(std::move(file)), m_type(type) {}

		Shader(const std::string& file, const shader::ShaderType& type) : Shader(shader::DEFAULT_SHADER_LOCATION, file, type) {}
	...
	public:
		...
		ShaderProgram(const std::string& vfile, const std::string& ffile) : ShaderProgram(shader::DEFAULT_SHADER_LOCATION, vfile,
		...
		ShaderProgram(const std::string& vfile, const std::string& ffile, const std::string& gfile) : ShaderProgram(shader::DEFAULT_SHADER_LOCATION, vfile,
			shader::DEFAULT_SHADER_LOCATION, ffile,
