...
/*
 * This abstract class provides a standard base for the most of basic shapes
...
public:
    ...
    void attachTexture(Texture texture) {
        ...
        glBufferData(GL_ARRAY_BUFFER, this->texCoord.size() * sizeof(vec2),
                     this->texCoord.data(), GL_STATIC_DRAW);
